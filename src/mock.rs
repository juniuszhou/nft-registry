...
(module
    ...
    (func (export "deploy"))
    ;; Generated by codec::Encode::encode(&Call::NftRegistry(nftregistry::Call::finish_mint_unit_test(registry_id))))
    (data (i32.const 8) "\02\06\00\00\00\00\00\00\00\00")
)
"#;
